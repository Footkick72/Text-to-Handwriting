...
class AutoDocumentCreator {
    ...
    let instructions = """
                                            ...
                                            The template editor allows you to select a background image from your photos. Select where the text should be drawn on that image by dragging the center or corners of the red rectangle that appears. At the bottom there are options for text size, text color, and the type of writing tool.
